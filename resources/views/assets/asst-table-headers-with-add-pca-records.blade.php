<div class="card-header d-flex flex-wrap align-items-center justify-content-between"
    ...
    <p class="card-title mb-3 mb-md-0" style="color:#1f3c88; padding-left:0%; font-size: 22px"><b>Personal Cash
            Advance</b>
    </p>
    <div class="d-flex flex-wrap align-items-center ml-auto">
        <form class="form-inline mr-auto mr-md-0 mb-2 mb-md-0" style="display: flex; align-items: center;">
            <div class="nav-item btn btn-sm p-0" id="selectToAddStudentPersonalCA"
