                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="payable_status" class="form-control" id="payable_status" required>
                                    <option value="paid" @if ($student->payable_status == 'paid') selected @endif>Paid</option>
                                    <option value="unpaid" @if ($student->payable_status == 'unpaid') selected @endif>Unpaid
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="account_status" class="form-control" id="account_status" required>
                                    <option value="active" @if ($student->account_status == 'active') selected @endif>Active
                                    </option>
                                    <option value="closed" @if ($student->account_status == 'closed') selected @endif>Closed
                                    </option>
                                </select>
                            </div>
