    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body" style="background-color: none; border: none;">
                ...
                <form id="add-student-form" enctype="multipart/form-data" method="POST" action="{{ route('admin.storeStudentAccount') }}">
                    @csrf
                    ...
                    <div class="row" style="text-align: left;">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="last_name_student" name="last_name" required />
                            </div>
                            @error('last_name')
                                <div class="alert alert-danger">
                                    {{$message}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email_student_off" value="Auto-Generated" disabled/>
                            </div>
                            @error('email')
                                <div class="alert alert-danger">
                                    {{$message}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="password_student" value="d3f@ultP@$$w0rd" disabled/>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" max="{{now()->subYears(18)->format('Y-m-d')}}" class="form-control" id="birthdate_student" name="birthdate" required />
                            </div>
                            @error('birthdate')
                                <div class="alert alert-danger">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="parent_contact_student" name="parent_contact" />
                            </div>
                            ...
                            <div class="form-group" style="float: right;">
                                ...
                                <a href="{{ route('admin.student-accounts') }}" class="btn btn-default">Back</a>
                            </div>
                        </div>
                    </div>
                </form>
