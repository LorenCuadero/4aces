                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example2" class="table table-hover data-table text-center"
                                    ...
                                    <tbody class="table-body">
                                        @forelse ($students as $student)
                                            <tr class="table-row">
                                                <td class="align-middle">
                                                    ...
                                                    @if (
                                                        $student->middle_name &&
                                                            ...
                                                            ($student->middle_name && $student->middle_name != 'n/a'))
                                                        {{ ' ' . $student->middle_name }}
                                                    @endif
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('admin.reports.getStudentGradeReport', ['id' => $student->id]) }}"
                                                        class="btn btn-sm" id="grade-button"
                                                        style="color: #1f3c88;width:50%; border-radius: 20px; margin: 2px">
                                                        <strong><i class="fa-solid fa-book mr-1" style="17px"></i>
                                                            Grade</strong>
                                                    </a>
                                                </td>
                                            </tr>
