    ...
    <div class="modal-dialog custom-modal-width" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="student-selection-modal-label">Personal Cash Advance Payables</h5>
                                        ...
                                        <form>
                                            <table id="selection"
                                                ...
                                                <tbody class="table-body1">
                                                    @forelse ($unpaidPersonalCARecords as $record)
                                                        <tr class="table-row1">
                                                            <td>{{ \Carbon\Carbon::parse($record->date)->format('F d, Y') }}
                                                            </td>
                                                            <td>₱ {{ number_format($record->amount_due - $record->amount_paid, 2) }}
                                                            </td>
                                                        </tr>
                                                    @empty
                                                        <tr>
