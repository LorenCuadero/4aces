<div class="modal fade" id="add-admin-student-dcpl-modal" tabindex="-1" role="dialog" aria-labelledby="add-student-modal-label"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="student-selection-modal-label">Warning for
                    <span class="Input first_name_dcpl_admin"></span><span class="Input last_name_dcpl_admin"></span>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <a href="#" data-toggle="modal" data-target="#admin-student-selection-modal"><span
                            aria-hidden="true">&times;</span></a>
                </button>
            </div>
            <form id="new-form-dcpl" method="POST" action="{{ route('admin.reports.storeForAdmin') }}" class="text-left">
                @csrf
                <div class="modal-body b-gray-color p-2">
                    <input class="form-control student_id_dcpl_input_admin" type="hidden" name="student_id_dcpl_input_admin"
                        value="">
